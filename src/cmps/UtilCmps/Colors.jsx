...
const colors = {
    lime: ["#EFFFD6", "#D3F1A7", "#B3DF72", "#B3DF72", "#82B536", "#6A9A23", "#5B7F24", "#4C6B1F", "#37471F", "#28311B"],
    ...
    teal: ["#E7F9FF", "#C6EDFB", "#C6EDFB", "#9DD9EE", "#6CC3E0", "#2898BD", "#227D9B", "#206A83", "#164555", "#1E3137"],
    ...
    magenta: ["#FFECF8", "#FDD0EC", "#F797D2", "#E774BB", "#DA62AC", "#CD519D", "#AE4787", "#943D73", "#50253F", "#3D2232"],
    neutral_solid_light_mode: ["#FFFFFF", "#F7F8F9", "#F1F2F4", "#DCDFE4", "#B3B9C4", "#8590A2", "#758195", "#626F86", "#44546F", "#2C3E5D", "#172B4D", "#091E42"],
    neutral_alpha_light_mode: ["#091E4208", "#091E420F", "#091E4224", "#091E424F", "#091E427D"],
    neutral_solid_dark_mode: ["#101214", "#161A1D", "#1D2125", "#22272B", "#282E33", "#2C333A", "#38414A", "#454F59", "#596773", "#738496", "#8C9BAB", "#9FADBC", "#B6C2CF", "#C7D1DB", "#DEE4EA"],
    neutral_alpha_dark_mode: ["#03040442", "#BCD6F00A", "#A1BDD914", "#C8E1F91A", "#A6C5E229", "#C3DEFE33", "#BFDBF847", "#9BB4CA80"]
  }
