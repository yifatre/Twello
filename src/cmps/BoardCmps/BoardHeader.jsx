...
export function BoardHeader({ setBoardFilter, board, setRsbIsOpen, setViewType, viewType }) {
    ...
    return (<>
        <header className="board-header">
            ...
            <input className="board-title" type="text" style={{ width: titleToEdit.length * 1.2 + 'ch' }} name="board-title" id="board-title" value={titleToEdit} onChange={handleChangeTitle} onKeyDown={onKeyDown} onBlur={() => updateBoardOptimistic({ ...board, title: titleToEdit }, true)} />
